//package com.april2nd.live1.board.aop;
//
...
//
//	@Before(value = "execution(* com.april2nd.live1.board.model..Board*.*(..))")
...
//	}
//
//	@Around(value = "execution(* com.april2nd.live1.board.model..Board*.*(..))")
...
//	}
//
//	@AfterReturning(value = "execution(* com.april2nd.live1.board.model..Board*.list*(..))", returning = "obj")
...
//	}
//
//	@AfterThrowing(value = "execution(* com.april2nd.live1.board.model..Board*.list*(..))", throwing = "exception")
//	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
//		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
//		logger.debug("exception : {}", exception);
//	}
//
//	@After(value = "execution(* com.april2nd.live1.board.model..Board*.list*(..))")
