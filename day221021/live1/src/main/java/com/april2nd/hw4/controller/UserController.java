package com.april2nd.hw4.controller;
...
import com.april2nd.hw4.model.dto.User;
...
public class UserController {
	 ...
	 */
	@PostMapping("/hw4/login")
	public String doLogin(User user, HttpSession session, Model model) {
		String view = "/hw4/index";
