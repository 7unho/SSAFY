...
public class MemberController {
    ...
    @PostMapping("/update")
    public String updateMember(HttpSession session, MemberDto user, Model model){
        try{
    ...
    public String deleteMember(@PathVariable("userid") String userId, HttpSession session, Model model){
        try{
