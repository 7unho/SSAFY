package com.april2nd.live2.board.aop;
...
public class LoggingAspect {
	...
	@Before(value = "execution(* com.april2nd.live.board.model..Board*.*(..))")
	...
	@Around(value = "execution(* com.april2nd.live.board.model..Board*.*(..))")
	...
	@AfterReturning(value = "execution(* com.april2nd.live.board.model..Board*.list*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.april2nd.live.board.model..Board*.list*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.april2nd.live.board.model..Board*.list*(..))")
